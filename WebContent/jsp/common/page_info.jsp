...
<%@ include file="/jsp/common/taglibs.jsp"%>
    ...
    <input class="skipThese" type="hidden" name="currentPage" id="currentPage" value="${pageModel.pageNo}"/>
      <tr>
        <td><div><span width="33%" class="STYLE22" align="left">&nbsp;&nbsp;&nbsp;&nbsp; 共
        <strong>${pageModel.pageCount}</strong>  页,
        <strong> ${pageModel.rowsCount}</strong>条记录</span></div></td>
        <td width="67%"><table width="auto" border="0" align="right" cellpadding="0" cellspacing="0" >
          <tr>
            <c:if test="${pageModel.pageNo==1 }">
	            <td><div align="center" class="page_shouye"><a href="javascript:">首页</a></div></td>
	            <td><div align="center" class="page_next"><a href="javascript:"> 前一页</a></div></td>
            </c:if>
            <c:if test="${pageModel.pageNo > 1 }">
	            <td><div align="center" class="page_shouye"><a href="javascript:first();" >首页</a></div></td>
	            <td><div align="center" class="page_next"><a href="javascript:previous();" >前一页</a></div></td>
            </c:if>
            <td><div align="center" class="page_shuzi">
	           ...
	           <c:if test="${pageModel.pageNo < pageModel.pageCount}">
	            <td><div class="page_next"><a href="javascript:next();" >下一页</a></div></td>
	            <td><div class="page_shouye"><a href="javascript:end();" >尾页</a></div></td>
	           </c:if>
	           <c:if test="${pageModel.pageNo==pageModel.pageCount}">
	            <td><div class="page_next"><a href="javascript:">下一页</a></div></td>
	            <td><div class="page_shouye"><a href="javascript:">尾页</a></div></td>
	           </c:if>
            <td class="STYLE22"><div style="margin:0px 5px">跳转至</div></td>
            ...
            <td class="STYLE22"><div style="margin:0px 5px">页</div></td>
            <td class="STYLE22"><div class="page_shouye01"><a href="javascript:jumpForButton();" >go</a></div></td>
           </tr>  
           </table>  
        </td> 
       </td>
