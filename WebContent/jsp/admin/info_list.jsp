			...
			<c:forEach var="info" items="${pageModel.datas}" varStatus="status">
				<tr class="table001" height="32">
					...
					<td height="32"><div align="center">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;<a href="/manage/viewInfo/${info.id }" class="edit" target="_blank">预览</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:toEditInfo('${info.id }')" class="edit">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
